...
var game = {
    ...
    timeUp: function () {
        clearInterval(timer);
        $("#counter-start").append('<button class="replay-button" value="Reload Page" onClick="location.reload()">Try again?</button>');
    ...
    result: function () {
        ...
        endDiv.append('<button class="replay-button" value="Reload Page" onClick="location.reload()">Try again?</button>')
    }
};
